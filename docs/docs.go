    ...
    "paths": {
        "/achievements": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Achievement data - See examples in SWAGGER_EXAMPLES.md",
                        "name": "achievement",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/achievements/{id}/attachments": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid file or achievement ID",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/achievements/{id}/history": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Achievement status history",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/auth/login": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Login successful - use 'data.token' value in Authorize (not 'data.access_token')",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/reports/statistics/competition-levels": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "Competition level distribution retrieved",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/users": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "User creation data. Example for MAHASISWA: {\\",
                        "name": "user",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "service.CreateAchievementRequest": {
            ...
            "properties": {
                ...
                "attachments": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/service.AttachmentRequest"
                    }
                },
                "data": {
                    "type": "object",
        ...
        "service.CreateUserRequest": {
            ...
            "properties": {
                ...
                "role_name": {
                    "description": "Support role assignment by name (Admin, Mahasiswa, Dosen Wali)",
                    "type": "string"
                },
                "student_id": {
                    "type": "string"
